  ...
  return (
    <div
      className={cn(
        ...
        variant === "polaroid" && "bg-card border-2 border-secondary/70 p-3 pb-10 shadow-[6px_6px_18px_rgba(91,70,54,0.1)] rounded-sm rotate-[-1.5deg] hover:rotate-0 hover:scale-[1.03] transition-transform duration-300",

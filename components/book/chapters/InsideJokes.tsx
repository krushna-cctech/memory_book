...
export const InsideJokes = ({ jokes }: InsideJokesProps) => {
  ...
  return (
    <motion.div
      ...
      className="w-full space-y-6 md:space-y-7 max-w-xl mx-auto py-1 text-left relative"
    >
      {jokes.map((item, index) => {
        ...
        return (
          ...
          >
            <div
              className={`max-w-[85%] p-4 md:p-5 border-2 border-primary/95 shadow-[2px_2px_0px_rgba(91,70,54,0.15)] rounded-xl relative ${
            ...
            >
              ...
              <p className="font-serif text-xs md:text-sm font-bold text-primary leading-relaxed">
                {item.joke}
              </p>
            </div>
            
            <span className="font-handwritten text-xs md:text-sm text-accent mt-1.5 select-none px-2 rotate-[-0.5deg] font-bold">
